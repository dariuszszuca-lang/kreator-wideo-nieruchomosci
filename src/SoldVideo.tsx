      ...
      {particles.map((p, i) => (
        <div
          ...
          style={{
            ...
            transform: `translate(${p.x}px, ${p.y}px) rotate(${p.angle + frame * 3}deg)`,
            opacity: p.opacity,
          }}
        />
      ))}
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 80,
          textAlign: "center",
          opacity: interpolate(frame, [25, 40], [0, 0.4], { extrapolateRight: "clamp" }),
        }}
      >
        <div
          style={{
...
// --- MAIN COMPOSITION (240 frames = 8s) ---
// Photo: 0-89 (3s)
// SPRZEDANE: 90-179 (3s)
// Thank you: 180-239 (2s)
